...
// Copyright (c) 2017 The COTN coin developers
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // COTN coin: 1 day
        nTargetSpacing = 2 * 60;  // COTN coin: 2 minutes
        nMaturity = 10;
        ...
        nLastPOWBlock = 200;
        nModifierUpdateBlock = 1; // we use the version 2 for COTN
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1524042316;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 347599;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000e49817c7d0b2bc420381001e7fd1363e4dca5d279c4b9c4317a75efd33a"));
	...
	vSeeds.push_back(CDNSSeedData("174.138.44.238", "174.138.44.238"));
        ...
        // COTN coin script addresses start with '3'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 6);
        // COTN coin private keys start with 'K'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 46);
        // COTN coin BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // COTN coin BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // COTN coin BIP44 coin type is '222' (0x800000de)
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // COTN coin: 1 day
        nTargetSpacing = 2 * 60;  // COTN coin: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        genesis.nNonce = 2646574;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x0000060f80db96f6b9ad5840d3f2959cd5c2f9cb721b2f16c779fa3e749985a6"));

        vFixedSeeds.clear();
        vSeeds.clear();

        // Testnet COTN coin addresses start with 'g'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 98);
        // Testnet COTN coin script addresses start with '5' or '6'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 12);
        // Testnet private keys start with 'k'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 108);
        // Testnet COTN coin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet COTN coin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // COTN coin: 1 day
        nTargetSpacing = 2 * 60;        // COTN coin: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        genesis.nTime = 1516926684;
        ...
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 23133;
        assert(hashGenesisBlock == uint256("0x3983bc0b8990f9ea794c1ec534ab70adc67520d2cab75e05693b4e9c646afd79"));
