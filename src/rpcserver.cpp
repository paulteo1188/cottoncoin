...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop COTN coin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "COTN coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* COTN coin features */
        {"cottoncoin", "masternode", &masternode, true, true, false},
        {"cottoncoin", "listmasternodes", &listmasternodes, true, true, false},
        {"cottoncoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cottoncoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cottoncoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cottoncoin", "masternodedebug", &masternodedebug, true, true, false},
        {"cottoncoin", "startmasternode", &startmasternode, true, true, false},
        {"cottoncoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cottoncoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cottoncoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cottoncoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cottoncoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cottoncoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cottoncoin", "mnbudget", &mnbudget, true, true, false},
        {"cottoncoin", "preparebudget", &preparebudget, true, true, false},
        {"cottoncoin", "submitbudget", &submitbudget, true, true, false},
        {"cottoncoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cottoncoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cottoncoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cottoncoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cottoncoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cottoncoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cottoncoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cottoncoin", "checkbudgets", &checkbudgets, true, true, false},
        {"cottoncoin", "mnsync", &mnsync, true, true, false},
        {"cottoncoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> cottoncoin-cli " + methodname + " " + args + "\n";
}
