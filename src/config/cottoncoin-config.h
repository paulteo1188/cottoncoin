/* src/config/cottoncoin-config.h.  Generated from cottoncoin-config.h.in by configure.  */
/* src/config/cottoncoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef COTN_CONFIG_H

#define COTN_CONFIG_H
...
#define PACKAGE_NAME "COTN coin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "COTN coin Core 1.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "cottoncoin"
