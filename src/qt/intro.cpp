...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("COTN coin Core"),
     ...
     * override -datadir in the cottoncoin.conf file in the default data directory
     * (to be consistent with cottoncoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
