                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("COTN coin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a COTN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cottoncoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About COTN coin Core"), this);
    aboutAction->setStatusTip(tr("Show information about COTN coin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for COTN coin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your COTN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified COTN addresses"));
    ...
    openAction->setStatusTip(tr("Open a cottoncoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the COTN coin Core help message to get a list with possible COTN coin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("COTN coin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to COTN coin network", "", count));
}
...
{
    QString strTitle = tr("COTN coin Core"); // default title
