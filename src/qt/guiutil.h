...
/** Utility functions used by the COTNcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render COTN addresses in monospace font
...
// Parse "cottoncoin:" URI into recipient object, return true on successful parsing
