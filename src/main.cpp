...
#if defined(NDEBUG)
#error "COTN coin cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in ucotn) are considered zero fee (for relaying and mining)
...
{
    RenameThread("cottoncoin-scriptch");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // COTN: We use certain sporks during IBD, so check to see if they are
