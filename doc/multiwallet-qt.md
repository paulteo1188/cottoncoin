...
In order to support loading of multiple wallets in cottoncoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cottoncoin.cpp.
...
Changes to cottoncoin.cpp
----------------------
cottoncoin.cpp is the entry point into cottoncoin-qt, and as such, will require some minor modifications to provide hooks for
