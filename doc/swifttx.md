...
This mechanism has been integrated into Bitcore-Node-COTNcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/cottoncoin/insight-api-cottoncoin#web-socket-api](https://github.com/cottoncoin/insight-api-cottoncoin#web-socket-api)
* API: [https://github.com/cottoncoin/insight-api-cottoncoin#swifttx-transactions](https://github.com/cottoncoin/insight-api-cottoncoin#swifttx-transactions)
...
By default, the COTN coin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the COTN coin Core daemon:
