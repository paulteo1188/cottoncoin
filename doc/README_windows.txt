...
Intro
-----
COTN coin (COTN) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. COTN coin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run cottoncoin-qt.exe.

COTN coin Core is the original COTN coin client and it builds the backbone of the network.
However, it downloads and stores the entire history of COTN coin transactions;
