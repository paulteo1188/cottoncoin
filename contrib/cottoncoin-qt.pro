...
HEADERS += src/bignum.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/cottoncoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/cottoncoin-cli.cpp \
           src/cottoncoin-tx.cpp \
           src/cottoncoin.cpp \
           src/db.cpp \
           ...
           src/qt/cottoncoin.cpp \
           src/qt/cottoncoinstrings.cpp \
...
RESOURCES += src/qt/cottoncoin.qrc src/qt/cottoncoin_locale.qrc

TRANSLATIONS += src/qt/locale/cottoncoin_bg.ts \
                src/qt/locale/cottoncoin_de.ts \
                src/qt/locale/cottoncoin_en.ts \
                src/qt/locale/cottoncoin_es.ts \
                src/qt/locale/cottoncoin_fi.ts \
                src/qt/locale/cottoncoin_fr.ts \
                src/qt/locale/cottoncoin_it.ts \
                src/qt/locale/cottoncoin_ja.ts \
                src/qt/locale/cottoncoin_pl.ts \
                src/qt/locale/cottoncoin_pt.ts \
                src/qt/locale/cottoncoin_ru.ts \
                src/qt/locale/cottoncoin_sk.ts \
                src/qt/locale/cottoncoin_sv.ts \
                src/qt/locale/cottoncoin_vi.ts \
                src/qt/locale/cottoncoin_zh_CN.ts \
                src/qt/locale/cottoncoin_zh_TW.ts
