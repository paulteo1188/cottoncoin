...
#   c) node1 mines 32 blocks, so now node 0 has 500000COTN, node 1 has 4250COTN, node2 has none.
#   d) node0 sends 601 COTN to node2, in two transactions (301 COTN, then 300 COTN).
