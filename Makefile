...
pkgdatadir = $(datadir)/cottoncoin
pkgincludedir = $(includedir)/cottoncoin
pkglibdir = $(libdir)/cottoncoin
pkglibexecdir = $(libexecdir)/cottoncoin
...
CONFIG_HEADER = $(top_builddir)/src/config/cottoncoin-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/cottoncoin-config.h.in \
...
ACLOCAL = ${SHELL} /home/ubuntu/cottoncoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/ubuntu/cottoncoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/ubuntu/cottoncoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/ubuntu/cottoncoin/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = cottoncoin-cli
BITCOIN_DAEMON_NAME = cottoncoind
BITCOIN_GUI_NAME = cottoncoin-qt
BITCOIN_TX_NAME = cottoncoin-tx
...
LUPDATE = 
MAINT = 
MAKEINFO = ${SHELL} /home/ubuntu/cottoncoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
PACKAGE_NAME = COTN coin Core
PACKAGE_STRING = COTN coin Core 1.1.0
PACKAGE_TARNAME = cottoncoin
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/ubuntu/cottoncoin
abs_srcdir = /home/ubuntu/cottoncoin
abs_top_builddir = /home/ubuntu/cottoncoin
abs_top_srcdir = /home/ubuntu/cottoncoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/ubuntu/cottoncoin/build-aux/install-sh
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_cottoncoin_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_cottoncoin_coverage.info test_cottoncoin.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/COTNcoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/cottoncoin-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/cottoncoin-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/cottoncoin-config.h
$(top_srcdir)/src/config/cottoncoin-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/cottoncoin-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/COTNcoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/COTNcoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/COTNcoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_cottoncoin.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_cottoncoin -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_cottoncoin_filtered.info: test_cottoncoin.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_cottoncoin_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_cottoncoin_coverage.info: baseline_filtered_combined.info test_cottoncoin_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_cottoncoin_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_cottoncoin_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_cottoncoin_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_cottoncoin.coverage/.dirstamp:  test_cottoncoin_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_cottoncoin.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_cottoncoin.coverage/ total.coverage/ $(OSX_APP)
