Contributing to COTN coin Core
==================================

The COTN coin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the COTN coin Core project, and is not to be
confused with overall COTN coin Network Protocol consensus changes.

Whether a pull request is merged into COTN coin Core rests with the project merge
...
Patches that change COTN coin consensus rules are considerably more involved than
...
Where a patch set proposes to change the COTN coin consensus, it must have been
...
The project leader is the release manager for each COTN coin Core release.
